...
# Buscar el archivo limitando a archivos PDF y filtrando por nombre
...
if ($resultados) {
    ...
    Write-Host "No se encontraron archivos PDF con el nombre '$archivoABuscar' en $directorioInicial"
